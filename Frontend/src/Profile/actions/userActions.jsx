...
export const loadUser=async(dispatch)=>{
    try {
        ...
        const {data} =await axios.get(`${process.env.BACKEND_URL}/api/myprofile`)
...
export const updateProfile=(userData)=>async (dispatch)=>{
    try {
        ...
        const {data}=await axios.put(`${process.env.BACKEND_URL}/api/update`,userData)
...
export const updatePassword=(formData)=>async (dispatch)=>{
    try {
        ...
        await axios.put(`${process.env.BACKEND_URL}/api/password/change`,formData,config)
