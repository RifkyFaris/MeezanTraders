...
export const lowstock = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://meezantraders.onrender.com/api/admin/low`);
...
export const expiry = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://meezantraders.onrender.com/api/admin/expiry`);
...
export const createNewProduct=productData=>async(dispatch)=>{
    try {
        ...
        const { data }  =  await axios.post(`https://meezantraders.onrender.com/api/supplier/product/new`,productData,config);
...
export const getAdminProducts  =  async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`https://meezantraders.onrender.com/api/admin/products`);
...
export const deleteProduct  = id =>  async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`https://meezantraders.onrender.com/api/supplier/product/${id}`);
...
export const updateProduct  = (id,productData) =>  async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`https://meezantraders.onrender.com/api/supplier/update/${id}`,productData);
